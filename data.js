window.ICONS = {
  ...
  twin: `<svg viewBox="0 0 64 64"><defs><linearGradient id="ta" x1="0" x2="0" y1="0" y2="1"><stop offset="0" stop-color="#1f4f8f"/><stop offset="1" stop-color="#0b1f3a"/></linearGradient></defs><rect x="4" y="4" width="56" height="56" rx="13" fill="url(#ta)"/><path d="M12 46h40" stroke="#6fa8ff" stroke-width="2"/><rect x="14" y="30" width="7" height="16" fill="#d9dde3"/><rect x="24" y="18" width="8" height="28" fill="#fff"/><rect x="35" y="26" width="6" height="20" fill="#b9c6d6"/><rect x="44" y="12" width="6" height="34" fill="#7fa3c9"/><circle cx="47" cy="10" r="2" fill="#ffb454"/></svg>`,
...
window.PROJECTS = [
  ...
  {
    id: "twin", name: "서울 트윈", sub: "서울 3D 디지털 트윈", icon: "twin", kind: "웹앱", live: "https://jihongparker.github.io/seoul-twin/",
    one: "서울의 건물과 지형, 자치구, 지하철을 3D 로 돌려 보고 확대하는 지도입니다. 키 없는 공개 자료만 써서 정적 파일로 동작합니다.",
    look: ["기본 모드: OpenStreetMap 건물 높이 압출, 시각별 조명과 낮·밤 전환, 자치구 정보 패널", "정밀 모드: Overture 건물 메시와 지형 메시를 CesiumJS 로 표시", "설명문 초안과 대표 이미지는 grok API 로 만들고 사실을 검수해 수록"],
    links: [["저장소", "https://github.com/JihongParker/seoul-twin"], ["정밀 모드", "https://jihongparker.github.io/seoul-twin/tiles.html"]],
  },
  {
...
window.PAPERS = [
  { n: "01", lead: true, file: "Park_hedge_optimization.pdf", kr: "고정 예산 아래 WTI와 원달러 헤지비율 배분", p: "월 예산과 옵션 만기가 어긋나는 문제를 12조각 스트립으로 맞추고, 꼬리 손실 기준으로 다시 최적화했습니다." },
  { n: "02", lead: true, file: "Park_Quanto.pdf", kr: "콴토 낙아웃의 공분산 인식 델타헤지", p: "WTI와 원달러의 공분산을 델타에 넣은 두 배리어 콴토 헤지입니다. 칼라와 견주어 어디서 갈라지는지 봅니다." },
  { n: "03", lead: true, file: "Park_CFH.pdf", kr: "IFRS 9 현금흐름위험회피, 통합 지정과 분리 지정", p: "같은 포지션을 두 가지 지정 구조로 회계처리했을 때 손익 변동과 비효과 부분이 어떻게 달라지는지 계산했습니다." },
  { n: "04", lead: true, file: "Park_ESG_disclosure.pdf", kr: "의무 ESG 공시와 기업 헤지", p: "코스피 380사의 2016년부터 2024년까지 공시로, 지배구조보고서와 환경정보 의무화가 헤지회계 채택과 파생 사용에 준 효과를 쟀습니다." },
...
window.TIMELINE = [
  ...
  { from: "2026", to: "2026.08", org: "WTI·원달러 헤지 연구 프로그램", items: [{ t: "논문 6편 (SSRN, ResearchGate)", b: ["고정 예산 배분, 콴토 낙아웃 델타헤지, IFRS 9 지정 구조, ESG 공시 효과, KIKO 노트 2편", "코스피 380사 2016~2024 OpenDART 패널 구축과 회귀 분석", "Python 엔진과 Excel VBA 감사, LaTeX 원고"] }] },
